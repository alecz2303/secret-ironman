...
/**
 * This is the model class for table "po_folios_control_expediente".
 *
 * The followings are the available columns in table 'po_folios_control_expediente':
 * @property integer $id
 * @property string $ep
 ...
 */
class PoFoliosControlExpediente extends CActiveRecord
{
    public $foliosxusar;
	/**
	...
	{
		return 'po_folios_control_expediente';
	}
		...
		return array(
			...
			array('libro', 'length', 'max'=>6),
                        array(
                            ...
                            'attributeName' => 'ep',
                            'caseSensitive'=> false,
                            'className'=>'PoFoliosControlExpediente',
