...
/**
 * This is the model class for table "testimonio_po".
 *
 * The followings are the available columns in table 'testimonio_po':
 * @property integer $id
 ...
 */
class TestimonioPo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('escritura, anno, nombre,fecha_entrega,recibe', 'required'),
			...
			array('fecha_entrega,recibe', 'safe', 'on'=>'create'),
                        array(
                            'escritura', 'unique',
                            'allowEmpty' => false,
                            'attributeName' => 'escritura',
                            'caseSensitive'=> false,
                            'className'=>'TestimonioPo',
	 ...
	 * @return TestimonioPo the static model class
	 */
