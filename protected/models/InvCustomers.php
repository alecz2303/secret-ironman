...
/**
 * This is the model class for table "inv_customers".
 *
 * The followings are the available columns in table 'inv_customers':
 * @property integer $id
 ...
 */
class InvCustomers extends CActiveRecord
{
    public $first_name;
    public $last_name;
    public $phone_number;
	...
	public function rules()
	{
		...
		return array(
			array('people_id, first_name, last_name, phone_number, email, address1, estado, mnpio, col, cp', 'required'),
			array('people_id, deleted, estado, mnpio, col, cp', 'numerical', 'integerOnly'=>true),
            array('email','email'),
            array('address2, comments', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, people_id, deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('deleted',$this->deleted);
                ...
                $criteria->order = 'people.last_name';
	 ...
	 * @return InvCustomers the static model class
	 */
