...
class BsHtml extends CHtml
{
    ...
    // ICON
    // --------------------------------------------------
    const FA_ADJUST                        = 'fa-adjust fa-fw';
    const FA_ADN                           = 'fa-adn fa-fw';
    const FA_ALIGN_CENTER                  = 'fa-align-center fa-fw';
    const FA_ALIGN_JUSTIFY                 = 'fa-align-justify fa-fw';
    const FA_ALIGN_LEFT                    = 'fa-align-left fa-fw';
    const FA_ALIGN_RIGHT                   = 'fa-align-right fa-fw';
    const FA_AMBULANCE                     = 'fa-ambulance fa-fw';
    const FA_ANCHOR                        = 'fa-anchor fa-fw';
    const FA_ANDROID                       = 'fa-android fa-fw';
    const FA_ANGLE_DOUBLE_DOWN             = 'fa-angle-double-down fa-fw';
    const FA_ANGLE_DOUBLE_LEFT             = 'fa-angle-double-left fa-fw';
    const FA_ANGLE_DOUBLE_RIGHT            = 'fa-angle-double-right fa-fw';
    const FA_ANGLE_DOUBLE_UP               = 'fa-angle-double-up fa-fw';
    const FA_ANGLE_DOWN                    = 'fa-angle-down fa-fw';
    const FA_ANGLE_LEFT                    = 'fa-angle-left fa-fw';
    const FA_ANGLE_RIGHT                   = 'fa-angle-right fa-fw';
    const FA_ANGLE_UP                      = 'fa-angle-up fa-fw';
    const FA_APPLE                         = 'fa-apple fa-fw';
    const FA_ARCHIVE                       = 'fa-archive fa-fw';
    const FA_ARROW_CIRCLE_DOWN             = 'fa-arrow-circle-down fa-fw';
    const FA_ARROW_CIRCLE_LEFT             = 'fa-arrow-circle-left fa-fw';
    const FA_ARROW_CIRCLE_O_DOWN           = 'fa-arrow-circle-o-down fa-fw';
    const FA_ARROW_CIRCLE_O_LEFT           = 'fa-arrow-circle-o-left fa-fw';
    const FA_ARROW_CIRCLE_O_RIGHT          = 'fa-arrow-circle-o-right fa-fw';
    const FA_ARROW_CIRCLE_O_UP             = 'fa-arrow-circle-o-up fa-fw';
    const FA_ARROW_CIRCLE_RIGHT            = 'fa-arrow-circle-right fa-fw';
    const FA_ARROW_CIRCLE_UP               = 'fa-arrow-circle-up fa-fw';
    const FA_ARROW_DOWN                    = 'fa-arrow-down fa-fw';
    const FA_ARROW_LEFT                    = 'fa-arrow-left fa-fw';
    const FA_ARROW_RIGHT                   = 'fa-arrow-right fa-fw';
    const FA_ARROW_UP                      = 'fa-arrow-up fa-fw';
    const FA_ARROWS                        = 'fa-arrows fa-fw';
    const FA_ARROWS_ALT                    = 'fa-arrows-alt fa-fw';
    const FA_ARROWS_H                      = 'fa-arrows-h fa-fw';
    const FA_ARROWS_V                      = 'fa-arrows-v fa-fw';
    const FA_ASTERISK                      = 'fa-asterisk fa-fw';
    const FA_AUTOMOBILE                    = 'fa-automobile fa-fw';
    const FA_BACKWARD                      = 'fa-backward fa-fw';
    const FA_BAN                           = 'fa-ban fa-fw';
    const FA_BANK                          = 'fa-bank fa-fw';
    const FA_BAR_CHART_O                   = 'fa-bar-chart-o fa-fw';
    const FA_BARCODE                       = 'fa-barcode fa-fw';
    const FA_BARS                          = 'fa-bars fa-fw';
    const FA_BEER                          = 'fa-beer fa-fw';
    const FA_BEHANCE                       = 'fa-behance fa-fw';
    const FA_BEHANCE_SQUARE                = 'fa-behance-square fa-fw';
    const FA_BELL                          = 'fa-bell fa-fw';
    const FA_BELL_O                        = 'fa-bell-o fa-fw';
    const FA_BITBUCKET                     = 'fa-bitbucket fa-fw';
    const FA_BITBUCKET_SQUARE              = 'fa-bitbucket-square fa-fw';
    const FA_BITCOIN                       = 'fa-bitcoin fa-fw';
    const FA_BOLD                          = 'fa-bold fa-fw';
    const FA_BOLT                          = 'fa-bolt fa-fw';
    const FA_BOMB                          = 'fa-bomb fa-fw';
    const FA_BOOK                          = 'fa-book fa-fw';
    const FA_BOOKMARK                      = 'fa-bookmark fa-fw';
    const FA_BOOKMARK_O                    = 'fa-bookmark-o fa-fw';
    const FA_BRIEFCASE                     = 'fa-briefcase fa-fw';
    const FA_BTC                           = 'fa-btc fa-fw';
    const FA_BUG                           = 'fa-bug fa-fw';
    const FA_BUILDING                      = 'fa-building fa-fw';
    const FA_BUILDING_O                    = 'fa-building-o fa-fw';
    const FA_BULLHORN                      = 'fa-bullhorn fa-fw';
    const FA_BULLSEYE                      = 'fa-bullseye fa-fw';
    const FA_CAB                           = 'fa-cab fa-fw';
    const FA_CALENDAR                      = 'fa-calendar fa-fw';
    const FA_CALENDAR_O                    = 'fa-calendar-o fa-fw';
    const FA_CAMERA                        = 'fa-camera fa-fw';
    const FA_CAMERA_RETRO                  = 'fa-camera-retro fa-fw';
    const FA_CAR                           = 'fa-car fa-fw';
    const FA_CARET_DOWN                    = 'fa-caret-down fa-fw';
    const FA_CARET_LEFT                    = 'fa-caret-left fa-fw';
    const FA_CARET_RIGHT                   = 'fa-caret-right fa-fw';
    const FA_CARET_SQUARE_O_DOWN           = 'fa-caret-square-o-down fa-fw';
    const FA_CARET_SQUARE_O_LEFT           = 'fa-caret-square-o-left fa-fw';
    const FA_CARET_SQUARE_O_RIGHT          = 'fa-caret-square-o-right fa-fw';
    const FA_CARET_SQUARE_O_UP             = 'fa-caret-square-o-up fa-fw';
    const FA_CARET_UP                      = 'fa-caret-up fa-fw';
    const FA_CERTIFICATE                   = 'fa-certificate fa-fw';
    const FA_CHAIN                         = 'fa-chain fa-fw';
    const FA_CHAIN_BROKEN                  = 'fa-chain-broken fa-fw';
    const FA_CHECK                         = 'fa-check fa-fw';
    const FA_CHECK_CIRCLE                  = 'fa-check-circle fa-fw';
    const FA_CHECK_CIRCLE_O                = 'fa-check-circle-o fa-fw';
    const FA_CHECK_SQUARE                  = 'fa-check-square fa-fw';
    const FA_CHECK_SQUARE_O                = 'fa-check-square-o fa-fw';
    const FA_CHEVRON_CIRCLE_DOWN           = 'fa-chevron-circle-down fa-fw';
    const FA_CHEVRON_CIRCLE_LEFT           = 'fa-chevron-circle-left fa-fw';
    const FA_CHEVRON_CIRCLE_RIGHT          = 'fa-chevron-circle-right fa-fw';
    const FA_CHEVRON_CIRCLE_UP             = 'fa-chevron-circle-up fa-fw';
    const FA_CHEVRON_DOWN                  = 'fa-chevron-down fa-fw';
    const FA_CHEVRON_LEFT                  = 'fa-chevron-left fa-fw';
    const FA_CHEVRON_RIGHT                 = 'fa-chevron-right fa-fw';
    const FA_CHEVRON_UP                    = 'fa-chevron-up fa-fw';
    const FA_CHILD                         = 'fa-child fa-fw';
    const FA_CIRCLE                        = 'fa-circle fa-fw';
    const FA_CIRCLE_O                      = 'fa-circle-o fa-fw';
    const FA_CIRCLE_O_NOTCH                = 'fa-circle-o-notch fa-fw';
    const FA_CIRCLE_THIN                   = 'fa-circle-thin fa-fw';
    const FA_CLIPBOARD                     = 'fa-clipboard fa-fw';
    const FA_CLOCK_O                       = 'fa-clock-o fa-fw';
    const FA_CLOUD                         = 'fa-cloud fa-fw';
    const FA_CLOUD_DOWNLOAD                = 'fa-cloud-download fa-fw';
    const FA_CLOUD_UPLOAD                  = 'fa-cloud-upload fa-fw';
    const FA_CNY                           = 'fa-cny fa-fw';
    const FA_CODE                          = 'fa-code fa-fw';
    const FA_CODE_FORK                     = 'fa-code-fork fa-fw';
    const FA_CODEPEN                       = 'fa-codepen fa-fw';
    const FA_COFFEE                        = 'fa-coffee fa-fw';
    const FA_COG                           = 'fa-cog fa-fw';
    const FA_COGS                          = 'fa-cogs fa-fw';
    const FA_COLUMNS                       = 'fa-columns fa-fw';
    const FA_COMMENT                       = 'fa-comment fa-fw';
    const FA_COMMENT_O                     = 'fa-comment-o fa-fw';
    const FA_COMMENTS                      = 'fa-comments fa-fw';
    const FA_COMMENTS_O                    = 'fa-comments-o fa-fw';
    const FA_COMPASS                       = 'fa-compass fa-fw';
    const FA_COMPRESS                      = 'fa-compress fa-fw';
    const FA_COPY                          = 'fa-copy fa-fw';
    const FA_CREDIT_CARD                   = 'fa-credit-card fa-fw';
    const FA_CROP                          = 'fa-crop fa-fw';
    const FA_CROSSHAIRS                    = 'fa-crosshairs fa-fw';
    const FA_CSS3                          = 'fa-css3 fa-fw';
    const FA_CUBE                          = 'fa-cube fa-fw';
    const FA_CUBES                         = 'fa-cubes fa-fw';
    const FA_CUT                           = 'fa-cut fa-fw';
    const FA_CUTLERY                       = 'fa-cutlery fa-fw';
    const FA_DASHBOARD                     = 'fa-dashboard fa-fw';
    const FA_DATABASE                      = 'fa-database fa-fw';
    const FA_DEDENT                        = 'fa-dedent fa-fw';
    const FA_DELICIOUS                     = 'fa-delicious fa-fw';
    const FA_DESKTOP                       = 'fa-desktop fa-fw';
    const FA_DEVIANTART                    = 'fa-deviantart fa-fw';
    const FA_DIGG                          = 'fa-digg fa-fw';
    const FA_DOLLAR                        = 'fa-dollar fa-fw';
    const FA_DOT_CIRCLE_O                  = 'fa-dot-circle-o fa-fw';
    const FA_DOWNLOAD                      = 'fa-download fa-fw';
    const FA_DRIBBBLE                      = 'fa-dribbble fa-fw';
    const FA_DROPBOX                       = 'fa-dropbox fa-fw';
    const FA_DRUPAL                        = 'fa-drupal fa-fw';
    const FA_EDIT                          = 'fa-edit fa-fw';
    const FA_EJECT                         = 'fa-eject fa-fw';
    const FA_ELLIPSIS_H                    = 'fa-ellipsis-h fa-fw';
    const FA_ELLIPSIS_V                    = 'fa-ellipsis-v fa-fw';
    const FA_EMPIRE                        = 'fa-empire fa-fw';
    const FA_ENVELOPE                      = 'fa-envelope fa-fw';
    const FA_ENVELOPE_O                    = 'fa-envelope-o fa-fw';
    const FA_ENVELOPE_SQUARE               = 'fa-envelope-square fa-fw';
    const FA_ERASER                        = 'fa-eraser fa-fw';
    const FA_EUR                           = 'fa-eur fa-fw';
    const FA_EURO                          = 'fa-euro fa-fw';
    const FA_EXCHANGE                      = 'fa-exchange fa-fw';
    const FA_EXCLAMATION                   = 'fa-exclamation fa-fw';
    const FA_EXCLAMATION_CIRCLE            = 'fa-exclamation-circle fa-fw';
    const FA_EXCLAMATION_TRIANGLE          = 'fa-exclamation-triangle fa-fw';
    const FA_EXPAND                        = 'fa-expand fa-fw';
    const FA_EXTERNAL_LINK                 = 'fa-external-link fa-fw';
    const FA_EXTERNAL_LINK_SQUARE          = 'fa-external-link-square fa-fw';
    const FA_EYE                           = 'fa-eye fa-fw';
    const FA_EYE_SLASH                     = 'fa-eye-slash fa-fw';
    const FA_FACEBOOK                      = 'fa-facebook fa-fw';
    const FA_FACEBOOK_SQUARE               = 'fa-facebook-square fa-fw';
    const FA_FAST_BACKWARD                 = 'fa-fast-backward fa-fw';
    const FA_FAST_FORWARD                  = 'fa-fast-forward fa-fw';
    const FA_FAX                           = 'fa-fax fa-fw';
    const FA_FEMALE                        = 'fa-female fa-fw';
    const FA_FIGHTER_JET                   = 'fa-fighter-jet fa-fw';
    const FA_FILE                          = 'fa-file fa-fw';
    const FA_FILE_ARCHIVE_O                = 'fa-file-archive-o fa-fw';
    const FA_FILE_AUDIO_O                  = 'fa-file-audio-o fa-fw';
    const FA_FILE_CODE_O                   = 'fa-file-code-o fa-fw';
    const FA_FILE_EXCEL_O                  = 'fa-file-excel-o fa-fw';
    const FA_FILE_IMAGE_O                  = 'fa-file-image-o fa-fw';
    const FA_FILE_MOVIE_O                  = 'fa-file-movie-o fa-fw';
    const FA_FILE_O                        = 'fa-file-o fa-fw';
    const FA_FILE_PDF_O                    = 'fa-file-pdf-o fa-fw';
    const FA_FILE_PHOTO_O                  = 'fa-file-photo-o fa-fw';
    const FA_FILE_PICTURE_O                = 'fa-file-picture-o fa-fw';
    const FA_FILE_POWERPOINT_O             = 'fa-file-powerpoint-o fa-fw';
    const FA_FILE_SOUND_O                  = 'fa-file-sound-o fa-fw';
    const FA_FILE_TEXT                     = 'fa-file-text fa-fw';
    const FA_FILE_TEXT_O                   = 'fa-file-text-o fa-fw';
    const FA_FILE_VIDEO_O                  = 'fa-file-video-o fa-fw';
    const FA_FILE_WORD_O                   = 'fa-file-word-o fa-fw';
    const FA_FILE_ZIP_O                    = 'fa-file-zip-o fa-fw';
    const FA_FILES_O                       = 'fa-files-o fa-fw';
    const FA_FILM                          = 'fa-film fa-fw';
    const FA_FILTER                        = 'fa-filter fa-fw';
    const FA_FIRE                          = 'fa-fire fa-fw';
    const FA_FIRE_EXTINGUISHER             = 'fa-fire-extinguisher fa-fw';
    const FA_FLAG                          = 'fa-flag fa-fw';
    const FA_FLAG_CHECKERED                = 'fa-flag-checkered fa-fw';
    const FA_FLAG_O                        = 'fa-flag-o fa-fw';
    const FA_FLASH                         = 'fa-flash fa-fw';
    const FA_FLASK                         = 'fa-flask fa-fw';
    const FA_FLICKR                        = 'fa-flickr fa-fw';
    const FA_FLOPPY_O                      = 'fa-floppy-o fa-fw';
    const FA_FOLDER                        = 'fa-folder fa-fw';
    const FA_FOLDER_O                      = 'fa-folder-o fa-fw';
    const FA_FOLDER_OPEN                   = 'fa-folder-open fa-fw';
    const FA_FOLDER_OPEN_O                 = 'fa-folder-open-o fa-fw';
    const FA_FONT                          = 'fa-font fa-fw';
    const FA_FORWARD                       = 'fa-forward fa-fw';
    const FA_FOURSQUARE                    = 'fa-foursquare fa-fw';
    const FA_FROWN_O                       = 'fa-frown-o fa-fw';
    const FA_GAMEPAD                       = 'fa-gamepad fa-fw';
    const FA_GAVEL                         = 'fa-gavel fa-fw';
    const FA_GBP                           = 'fa-gbp fa-fw';
    const FA_GE                            = 'fa-ge fa-fw';
    const FA_GEAR                          = 'fa-gear fa-fw';
    const FA_GEARS                         = 'fa-gears fa-fw';
    const FA_GIFT                          = 'fa-gift fa-fw';
    const FA_GIT                           = 'fa-git fa-fw';
    const FA_GIT_SQUARE                    = 'fa-git-square fa-fw';
    const FA_GITHUB                        = 'fa-github fa-fw';
    const FA_GITHUB_ALT                    = 'fa-github-alt fa-fw';
    const FA_GITHUB_SQUARE                 = 'fa-github-square fa-fw';
    const FA_GITTIP                        = 'fa-gittip fa-fw';
    const FA_GLASS                         = 'fa-glass fa-fw';
    const FA_GLOBE                         = 'fa-globe fa-fw';
    const FA_GOOGLE                        = 'fa-google fa-fw';
    const FA_GOOGLE_PLUS                   = 'fa-google-plus fa-fw';
    const FA_GOOGLE_PLUS_SQUARE            = 'fa-google-plus-square fa-fw';
    const FA_GRADUATION_CAP                = 'fa-graduation-cap fa-fw';
    const FA_GROUP                         = 'fa-group fa-fw';
    const FA_H_SQUARE                      = 'fa-h-square fa-fw';
    const FA_HACKER_NEWS                   = 'fa-hacker-news fa-fw';
    const FA_HAND_O_DOWN                   = 'fa-hand-o-down fa-fw';
    const FA_HAND_O_LEFT                   = 'fa-hand-o-left fa-fw';
    const FA_HAND_O_RIGHT                  = 'fa-hand-o-right fa-fw';
    const FA_HAND_O_UP                     = 'fa-hand-o-up fa-fw';
    const FA_HDD_O                         = 'fa-hdd-o fa-fw';
    const FA_HEADER                        = 'fa-header fa-fw';
    const FA_HEADPHONES                    = 'fa-headphones fa-fw';
    const FA_HEART                         = 'fa-heart fa-fw';
    const FA_HEART_O                       = 'fa-heart-o fa-fw';
    const FA_HISTORY                       = 'fa-history fa-fw';
    const FA_HOME                          = 'fa-home fa-fw';
    const FA_HOSPITAL_O                    = 'fa-hospital-o fa-fw';
    const FA_HTML5                         = 'fa-html5 fa-fw';
    const FA_IMAGE                         = 'fa-image fa-fw';
    const FA_INBOX                         = 'fa-inbox fa-fw';
    const FA_INDENT                        = 'fa-indent fa-fw';
    const FA_INFO                          = 'fa-info fa-fw';
    const FA_INFO_CIRCLE                   = 'fa-info-circle fa-fw';
    const FA_INR                           = 'fa-inr fa-fw';
    const FA_INSTAGRAM                     = 'fa-instagram fa-fw';
    const FA_INSTITUTION                   = 'fa-institution fa-fw';
    const FA_ITALIC                        = 'fa-italic fa-fw';
    const FA_JOOMLA                        = 'fa-joomla fa-fw';
    const FA_JPY                           = 'fa-jpy fa-fw';
    const FA_JSFIDDLE                      = 'fa-jsfiddle fa-fw';
    const FA_KEY                           = 'fa-key fa-fw';
    const FA_KEYBOARD_O                    = 'fa-keyboard-o fa-fw';
    const FA_KRW                           = 'fa-krw fa-fw';
    const FA_LANGUAGE                      = 'fa-language fa-fw';
    const FA_LAPTOP                        = 'fa-laptop fa-fw';
    const FA_LEAF                          = 'fa-leaf fa-fw';
    const FA_LEGAL                         = 'fa-legal fa-fw';
    const FA_LEMON_O                       = 'fa-lemon-o fa-fw';
    const FA_LEVEL_DOWN                    = 'fa-level-down fa-fw';
    const FA_LEVEL_UP                      = 'fa-level-up fa-fw';
    const FA_LIFE_BOUY                     = 'fa-life-bouy fa-fw';
    const FA_LIFE_RING                     = 'fa-life-ring fa-fw';
    const FA_LIFE_SAVER                    = 'fa-life-saver fa-fw';
    const FA_LIGHTBULB_O                   = 'fa-lightbulb-o fa-fw';
    const FA_LINK                          = 'fa-link fa-fw';
    const FA_LINKEDIN                      = 'fa-linkedin fa-fw';
    const FA_LINKEDIN_SQUARE               = 'fa-linkedin-square fa-fw';
    const FA_LINUX                         = 'fa-linux fa-fw';
    const FA_LIST                          = 'fa-list fa-fw';
    const FA_LIST_ALT                      = 'fa-list-alt fa-fw';
    const FA_LIST_OL                       = 'fa-list-ol fa-fw';
    const FA_LIST_UL                       = 'fa-list-ul fa-fw';
    const FA_LOCATION_ARROW                = 'fa-location-arrow fa-fw';
    const FA_LOCK                          = 'fa-lock fa-fw';
    const FA_LONG_ARROW_DOWN               = 'fa-long-arrow-down fa-fw';
    const FA_LONG_ARROW_LEFT               = 'fa-long-arrow-left fa-fw';
    const FA_LONG_ARROW_RIGHT              = 'fa-long-arrow-right fa-fw';
    const FA_LONG_ARROW_UP                 = 'fa-long-arrow-up fa-fw';
    const FA_MAGIC                         = 'fa-magic fa-fw';
    const FA_MAGNET                        = 'fa-magnet fa-fw';
    const FA_MAIL_FORWARD                  = 'fa-mail-forward fa-fw';
    const FA_MAIL_REPLY                    = 'fa-mail-reply fa-fw';
    const FA_MAIL_REPLY_ALL                = 'fa-mail-reply-all fa-fw';
    const FA_MALE                          = 'fa-male fa-fw';
    const FA_MAP_MARKER                    = 'fa-map-marker fa-fw';
    const FA_MAXCDN                        = 'fa-maxcdn fa-fw';
    const FA_MEDKIT                        = 'fa-medkit fa-fw';
    const FA_MEH_O                         = 'fa-meh-o fa-fw';
    const FA_MICROPHONE                    = 'fa-microphone fa-fw';
    const FA_MICROPHONE_SLASH              = 'fa-microphone-slash fa-fw';
    const FA_MINUS                         = 'fa-minus fa-fw';
    const FA_MINUS_CIRCLE                  = 'fa-minus-circle fa-fw';
    const FA_MINUS_SQUARE                  = 'fa-minus-square fa-fw';
    const FA_MINUS_SQUARE_O                = 'fa-minus-square-o fa-fw';
    const FA_MOBILE                        = 'fa-mobile fa-fw';
    const FA_MOBILE_PHONE                  = 'fa-mobile-phone fa-fw';
    const FA_MONEY                         = 'fa-money fa-fw';
    const FA_MOON_O                        = 'fa-moon-o fa-fw';
    const FA_MORTAR_BOARD                  = 'fa-mortar-board fa-fw';
    const FA_MUSIC                         = 'fa-music fa-fw';
    const FA_NAVICON                       = 'fa-navicon fa-fw';
    const FA_OPENID                        = 'fa-openid fa-fw';
    const FA_OUTDENT                       = 'fa-outdent fa-fw';
    const FA_PAGELINES                     = 'fa-pagelines fa-fw';
    const FA_PAPER_PLANE                   = 'fa-paper-plane fa-fw';
    const FA_PAPER_PLANE_O                 = 'fa-paper-plane-o fa-fw';
    const FA_PAPERCLIP                     = 'fa-paperclip fa-fw';
    const FA_PARAGRAPH                     = 'fa-paragraph fa-fw';
    const FA_PASTE                         = 'fa-paste fa-fw';
    const FA_PAUSE                         = 'fa-pause fa-fw';
    const FA_PAW                           = 'fa-paw fa-fw';
    const FA_PENCIL                        = 'fa-pencil fa-fw';
    const FA_PENCIL_SQUARE                 = 'fa-pencil-square fa-fw';
    const FA_PENCIL_SQUARE_O               = 'fa-pencil-square-o fa-fw';
    const FA_PHONE                         = 'fa-phone fa-fw';
    const FA_PHONE_SQUARE                  = 'fa-phone-square fa-fw';
    const FA_PHOTO                         = 'fa-photo fa-fw';
    const FA_PICTURE_O                     = 'fa-picture-o fa-fw';
    const FA_PIED_PIPER                    = 'fa-pied-piper fa-fw';
    const FA_PIED_PIPER_ALT                = 'fa-pied-piper-alt fa-fw';
    const FA_PIED_PIPER_SQUARE             = 'fa-pied-piper-square fa-fw';
    const FA_PINTEREST                     = 'fa-pinterest fa-fw';
    const FA_PINTEREST_SQUARE              = 'fa-pinterest-square fa-fw';
    const FA_PLANE                         = 'fa-plane fa-fw';
    const FA_PLAY                          = 'fa-play fa-fw';
    const FA_PLAY_CIRCLE                   = 'fa-play-circle fa-fw';
    const FA_PLAY_CIRCLE_O                 = 'fa-play-circle-o fa-fw';
    const FA_PLUS                          = 'fa-plus fa-fw';
    const FA_PLUS_CIRCLE                   = 'fa-plus-circle fa-fw';
    const FA_PLUS_SQUARE                   = 'fa-plus-square fa-fw';
    const FA_PLUS_SQUARE_O                 = 'fa-plus-square-o fa-fw';
    const FA_POWER_OFF                     = 'fa-power-off fa-fw';
    const FA_PRINT                         = 'fa-print fa-fw';
    const FA_PUZZLE_PIECE                  = 'fa-puzzle-piece fa-fw';
    const FA_QQ                            = 'fa-qq fa-fw';
    const FA_QRCODE                        = 'fa-qrcode fa-fw';
    const FA_QUESTION                      = 'fa-question fa-fw';
    const FA_QUESTION_CIRCLE               = 'fa-question-circle fa-fw';
    const FA_QUOTE_LEFT                    = 'fa-quote-left fa-fw';
    const FA_QUOTE_RIGHT                   = 'fa-quote-right fa-fw';
    const FA_RA                            = 'fa-ra fa-fw';
    const FA_RANDOM                        = 'fa-random fa-fw';
    const FA_REBEL                         = 'fa-rebel fa-fw';
    const FA_RECYCLE                       = 'fa-recycle fa-fw';
    const FA_REDDIT                        = 'fa-reddit fa-fw';
    const FA_REDDIT_SQUARE                 = 'fa-reddit-square fa-fw';
    const FA_REFRESH                       = 'fa-refresh fa-fw';
    const FA_RENREN                        = 'fa-renren fa-fw';
    const FA_REORDER                       = 'fa-reorder fa-fw';
    const FA_REPEAT                        = 'fa-repeat fa-fw';
    const FA_REPLY                         = 'fa-reply fa-fw';
    const FA_REPLY_ALL                     = 'fa-reply-all fa-fw';
    const FA_RETWEET                       = 'fa-retweet fa-fw';
    const FA_RMB                           = 'fa-rmb fa-fw';
    const FA_ROAD                          = 'fa-road fa-fw';
    const FA_ROCKET                        = 'fa-rocket fa-fw';
    const FA_ROTATE_LEFT                   = 'fa-rotate-left fa-fw';
    const FA_ROTATE_RIGHT                  = 'fa-rotate-right fa-fw';
    const FA_ROUBLE                        = 'fa-rouble fa-fw';
    const FA_RSS                           = 'fa-rss fa-fw';
    const FA_RSS_SQUARE                    = 'fa-rss-square fa-fw';
    const FA_RUB                           = 'fa-rub fa-fw';
    const FA_RUBLE                         = 'fa-ruble fa-fw';
    const FA_RUPEE                         = 'fa-rupee fa-fw';
    const FA_SAVE                          = 'fa-save fa-fw';
    const FA_SCISSORS                      = 'fa-scissors fa-fw';
    const FA_SEARCH                        = 'fa-search fa-fw';
    const FA_SEARCH_MINUS                  = 'fa-search-minus fa-fw';
    const FA_SEARCH_PLUS                   = 'fa-search-plus fa-fw';
    const FA_SEND                          = 'fa-send fa-fw';
    const FA_SEND_O                        = 'fa-send-o fa-fw';
    const FA_SHARE                         = 'fa-share fa-fw';
    const FA_SHARE_ALT                     = 'fa-share-alt fa-fw';
    const FA_SHARE_ALT_SQUARE              = 'fa-share-alt-square fa-fw';
    const FA_SHARE_SQUARE                  = 'fa-share-square fa-fw';
    const FA_SHARE_SQUARE_O                = 'fa-share-square-o fa-fw';
    const FA_SHIELD                        = 'fa-shield fa-fw';
    const FA_SHOPPING_CART                 = 'fa-shopping-cart fa-fw';
    const FA_SIGN_IN                       = 'fa-sign-in fa-fw';
    const FA_SIGN_OUT                      = 'fa-sign-out fa-fw';
    const FA_SIGNAL                        = 'fa-signal fa-fw';
    const FA_SITEMAP                       = 'fa-sitemap fa-fw';
    const FA_SKYPE                         = 'fa-skype fa-fw';
    const FA_SLACK                         = 'fa-slack fa-fw';
    const FA_SLIDERS                       = 'fa-sliders fa-fw';
    const FA_SMILE_O                       = 'fa-smile-o fa-fw';
    const FA_SORT                          = 'fa-sort fa-fw';
    const FA_SORT_ALPHA_ASC                = 'fa-sort-alpha-asc fa-fw';
    const FA_SORT_ALPHA_DESC               = 'fa-sort-alpha-desc fa-fw';
    const FA_SORT_AMOUNT_ASC               = 'fa-sort-amount-asc fa-fw';
    const FA_SORT_AMOUNT_DESC              = 'fa-sort-amount-desc fa-fw';
    const FA_SORT_ASC                      = 'fa-sort-asc fa-fw';
    const FA_SORT_DESC                     = 'fa-sort-desc fa-fw';
    const FA_SORT_DOWN                     = 'fa-sort-down fa-fw';
    const FA_SORT_NUMERIC_ASC              = 'fa-sort-numeric-asc fa-fw';
    const FA_SORT_NUMERIC_DESC             = 'fa-sort-numeric-desc fa-fw';
    const FA_SORT_UP                       = 'fa-sort-up fa-fw';
    const FA_SOUNDCLOUD                    = 'fa-soundcloud fa-fw';
    const FA_SPACE_SHUTTLE                 = 'fa-space-shuttle fa-fw';
    const FA_SPINNER                       = 'fa-spinner fa-fw';
    const FA_SPOON                         = 'fa-spoon fa-fw';
    const FA_SPOTIFY                       = 'fa-spotify fa-fw';
    const FA_SQUARE                        = 'fa-square fa-fw';
    const FA_SQUARE_O                      = 'fa-square-o fa-fw';
    const FA_STACK_EXCHANGE                = 'fa-stack-exchange fa-fw';
    const FA_STACK_OVERFLOW                = 'fa-stack-overflow fa-fw';
    const FA_STAR                          = 'fa-star fa-fw';
    const FA_STAR_HALF                     = 'fa-star-half fa-fw';
    const FA_STAR_HALF_EMPTY               = 'fa-star-half-empty fa-fw';
    const FA_STAR_HALF_FULL                = 'fa-star-half-full fa-fw';
    const FA_STAR_HALF_O                   = 'fa-star-half-o fa-fw';
    const FA_STAR_O                        = 'fa-star-o fa-fw';
    const FA_STEAM                         = 'fa-steam fa-fw';
    const FA_STEAM_SQUARE                  = 'fa-steam-square fa-fw';
    const FA_STEP_BACKWARD                 = 'fa-step-backward fa-fw';
    const FA_STEP_FORWARD                  = 'fa-step-forward fa-fw';
    const FA_STETHOSCOPE                   = 'fa-stethoscope fa-fw';
    const FA_STOP                          = 'fa-stop fa-fw';
    const FA_STRIKETHROUGH                 = 'fa-strikethrough fa-fw';
    const FA_STUMBLEUPON                   = 'fa-stumbleupon fa-fw';
    const FA_STUMBLEUPON_CIRCLE            = 'fa-stumbleupon-circle fa-fw';
    const FA_SUBSCRIPT                     = 'fa-subscript fa-fw';
    const FA_SUITCASE                      = 'fa-suitcase fa-fw';
    const FA_SUN_O                         = 'fa-sun-o fa-fw';
    const FA_SUPERSCRIPT                   = 'fa-superscript fa-fw';
    const FA_SUPPORT                       = 'fa-support fa-fw';
    const FA_TABLE                         = 'fa-table fa-fw';
    const FA_TABLET                        = 'fa-tablet fa-fw';
    const FA_TACHOMETER                    = 'fa-tachometer fa-fw';
    const FA_TAG                           = 'fa-tag fa-fw';
    const FA_TAGS                          = 'fa-tags fa-fw';
    const FA_TASKS                         = 'fa-tasks fa-fw';
    const FA_TAXI                          = 'fa-taxi fa-fw';
    const FA_TENCENT_WEIBO                 = 'fa-tencent-weibo fa-fw';
    const FA_TERMINAL                      = 'fa-terminal fa-fw';
    const FA_TEXT_HEIGHT                   = 'fa-text-height fa-fw';
    const FA_TEXT_WIDTH                    = 'fa-text-width fa-fw';
    const FA_TH                            = 'fa-th fa-fw';
    const FA_TH_LARGE                      = 'fa-th-large fa-fw';
    const FA_TH_LIST                       = 'fa-th-list fa-fw';
    const FA_THUMB_TACK                    = 'fa-thumb-tack fa-fw';
    const FA_THUMBS_DOWN                   = 'fa-thumbs-down fa-fw';
    const FA_THUMBS_O_DOWN                 = 'fa-thumbs-o-down fa-fw';
    const FA_THUMBS_O_UP                   = 'fa-thumbs-o-up fa-fw';
    const FA_THUMBS_UP                     = 'fa-thumbs-up fa-fw';
    const FA_TICKET                        = 'fa-ticket fa-fw';
    const FA_TIMES                         = 'fa-times fa-fw';
    const FA_TIMES_CIRCLE                  = 'fa-times-circle fa-fw';
    const FA_TIMES_CIRCLE_O                = 'fa-times-circle-o fa-fw';
    const FA_TINT                          = 'fa-tint fa-fw';
    const FA_TOGGLE_DOWN                   = 'fa-toggle-down fa-fw';
    const FA_TOGGLE_LEFT                   = 'fa-toggle-left fa-fw';
    const FA_TOGGLE_RIGHT                  = 'fa-toggle-right fa-fw';
    const FA_TOGGLE_UP                     = 'fa-toggle-up fa-fw';
    const FA_TRASH_O                       = 'fa-trash-o fa-fw';
    const FA_TREE                          = 'fa-tree fa-fw';
    const FA_TRELLO                        = 'fa-trello fa-fw';
    const FA_TROPHY                        = 'fa-trophy fa-fw';
    const FA_TRUCK                         = 'fa-truck fa-fw';
    const FA_TRY                           = 'fa-try fa-fw';
    const FA_TUMBLR                        = 'fa-tumblr fa-fw';
    const FA_TUMBLR_SQUARE                 = 'fa-tumblr-square fa-fw';
    const FA_TURKISH_LIRA                  = 'fa-turkish-lira fa-fw';
    const FA_TWITTER                       = 'fa-twitter fa-fw';
    const FA_TWITTER_SQUARE                = 'fa-twitter-square fa-fw';
    const FA_UMBRELLA                      = 'fa-umbrella fa-fw';
    const FA_UNDERLINE                     = 'fa-underline fa-fw';
    const FA_UNDO                          = 'fa-undo fa-fw';
    const FA_UNIVERSITY                    = 'fa-university fa-fw';
    const FA_UNLINK                        = 'fa-unlink fa-fw';
    const FA_UNLOCK                        = 'fa-unlock fa-fw';
    const FA_UNLOCK_ALT                    = 'fa-unlock-alt fa-fw';
    const FA_UNSORTED                      = 'fa-unsorted fa-fw';
    const FA_UPLOAD                        = 'fa-upload fa-fw';
    const FA_USD                           = 'fa-usd fa-fw';
    const FA_USER                          = 'fa-user fa-fw';
    const FA_USER_MD                       = 'fa-user-md fa-fw';
    const FA_USERS                         = 'fa-users fa-fw';
    const FA_VIDEO_CAMERA                  = 'fa-video-camera fa-fw';
    const FA_VIMEO_SQUARE                  = 'fa-vimeo-square fa-fw';
    const FA_VINE                          = 'fa-vine fa-fw';
    const FA_VK                            = 'fa-vk fa-fw';
    const FA_VOLUME_DOWN                   = 'fa-volume-down fa-fw';
    const FA_VOLUME_OFF                    = 'fa-volume-off fa-fw';
    const FA_VOLUME_UP                     = 'fa-volume-up fa-fw';
    const FA_WARNING                       = 'fa-warning fa-fw';
    const FA_WECHAT                        = 'fa-wechat fa-fw';
    const FA_WEIBO                         = 'fa-weibo fa-fw';
    const FA_WEIXIN                        = 'fa-weixin fa-fw';
    const FA_WHEELCHAIR                    = 'fa-wheelchair fa-fw';
    const FA_WINDOWS                       = 'fa-windows fa-fw';
    const FA_WON                           = 'fa-won fa-fw';
    const FA_WORDPRESS                     = 'fa-wordpress fa-fw';
    const FA_WRENCH                        = 'fa-wrench fa-fw';
    const FA_XING                          = 'fa-xing fa-fw';
    const FA_XING_SQUARE                   = 'fa-xing-square fa-fw';
    const FA_YAHOO                         = 'fa-yahoo fa-fw';
    const FA_YEN                           = 'fa-yen fa-fw';
    const FA_YOUTUBE                       = 'fa-youtube fa-fw';
    const FA_YOUTUBE_PLAY                  = 'fa-youtube-play fa-fw';
    const FA_YOUTUBE_SQUARE                = 'fa-youtube-square fa-fw';
...
EOD;
     ...
     * @return string the generated icon.
     */
    public static function iconFA($icon, $htmlOptions = array(), $tagName = 'span')
    {
        if (is_string($icon)) {
