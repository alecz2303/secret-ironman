		...
		return array(
			array('allow',
				'actions'=>array(
					...
					'addTabularInputs','addTabularInputsAsTable','uploadFile','addTabularInputsAsTableReceivings'
					),
				'users'=>array('*'),
				),
	...
	public function actions()
	{
		return array(
			...
			'addTabularInputsAsTable'=>array(
				'class'=>'ext.actions.XTabularInputAction',
				'modelName'=>'InvSalesItems',
				'viewName'=>'/invSalesItems/_tabularInputAsTable',
				),
			'addTabularInputsAsTableReceivings'=>array(
				'class'=>'ext.actions.XTabularInputAction',
				'modelName'=>'InvReceivingsItems',
				'viewName'=>'/invReceivingsItems/_tabularInputAsTable',
				),
			);
}
