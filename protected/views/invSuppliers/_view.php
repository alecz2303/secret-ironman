<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <b><?php echo CHtml::encode($data->getAttributeLabel('people.first_name')); ?>:</b>
	<?php echo CHtml::encode($data->people->first_name); ?>
	<br />
        
        <b><?php echo CHtml::encode($data->getAttributeLabel('people.last_name')); ?>:</b>
	<?php echo CHtml::encode($data->people->last_name); ?>
	<br />
