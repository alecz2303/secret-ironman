...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('pe-folios-control-expediente-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php echo BsHtml::pageHeader('Administración','Protocolo Especial Expedientes') ?>
<div class="panel panel-default">
    ...
    <div class="panel-body">
		...
		<?php $this->widget('bootstrap.widgets.BsGridView',array(
			'id'=>'pe-folios-control-expediente-grid',
