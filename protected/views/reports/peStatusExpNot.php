...
class PDF extends PDF_MySQL_Table
{
    ...
    function Header()
    {
        if($_GET['tipo']==='0'){
            ...
            $tipo = 'Promotora Vivienda';
        }else{
            $tipo = 'Secretaria de Educación';
        }            
        ...
        $this->Cell(0,10,'Protocolo Especial '.$tipo,0,1,'C');
...
$pdf->Table('select 
    ...
    "CHECK_MARK" as e12,
    "CHECK_MARK" as e3,
    if (r_rpp>0 or rpp>0 or (apendice = 1 and declaranot = 1) or (clg_fecha>0 and itd>0 and sap_fecha>0),"CHECK_MARK","") as e4,
    if (r_rpp>0 or rpp>0 or (apendice = 1 and declaranot = 1),"CHECK_MARK","") as e5,
    if (r_rpp>0 or rpp>0,"CHECK_MARK","") as e6,
