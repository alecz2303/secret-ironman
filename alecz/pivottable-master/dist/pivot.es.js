...
(function() {
  ...
  aggregators = (function(tpl) {
    return {
      "Cuenta": tpl.count(usFmtInt),
      //"Cuenta valores unicos": tpl.countUnique(usFmtInt),
      //"Enlista valores unicos": tpl.listUnique(", "),
      //"Sumatoria": tpl.sum(usFmt),
      //"Suma enteros": tpl.sum(usFmtInt),
      //"Porcentaje": tpl.average(usFmt),
      ...
      "Cuenta como fracción de Total": tpl.fractionOf(tpl.count(), "total", usFmtPct),
      "Cuenta como fracción de Filas": tpl.fractionOf(tpl.count(), "row", usFmtPct),
      "Cuenta como fracción de Columnas": tpl.fractionOf(tpl.count(), "col", usFmtPct)
    };
  })(aggregatorTemplates);
  ...
  renderers = {
    ...
    "Tabla Gráfico de Barras": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).barchart();
    },
    "Mapa de Calor": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).heatmap();
    },
    "Mapa de Calor x Fila": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).heatmap("rowheatmap");
    },
    "Mapa de Calor x Columna": function(pvtData, opts) {
